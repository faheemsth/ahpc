    ...
    <div class="row">
     <div class="col-md-10 col-lg-8 col-12 mt-5">
         <div class="col-12 d-flex mb-4 py-3 profile-direction" style="border: 1px solid rgb(211, 211, 211);border-radius: 5px;">
             <img src="<?php echo e(asset('build/images/users/khan.jpg')); ?>" alt="" class="m-2">
             <div class="mt-3 ms-3">
                 ...
                 <a href="<?php echo e(url('/site/profile')); ?>" class="px-3 py-2 text-light bg-success  rounded-2">Review Profile</a>
             </div>
         </div>


         <div class="col-12 d-flex  mb-4 py-3 profile-direction" style="border: 1px solid rgb(211, 211, 211);border-radius: 5px;">
             <img src="<?php echo e(asset('build/images/users/images.jpg')); ?>" alt="" class="m-2">
             <div class="mt-3 ms-3">
...
<?php echo $__env->make('site.sitelayout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/public_html/ahpc.smarttechnologyhouse.net/resources/views/site/member.blade.php ENDPATH**/ ?>