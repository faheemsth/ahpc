...
<?php $__env->startSection('content'); ?>
            ...
            <div class="card">
                <div class="card-header">
                    <ul class="nav nav-tabs-custom rounded card-header-tabs border-bottom-0" role="tablist">
                        <?php if(\Request::segment(1) == 'institutes'): ?>
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(!empty($_GET['id']) ? '' : 'active'); ?>" data-bs-toggle="tab"
                                    href="#documentTypes" role="tab">
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(!empty($_GET['id']) && $_GET['id'] == 'institute' ? 'active' : ''); ?>"
                                    data-bs-toggle="tab" href="#institute" role="tab">
                                    <i class="fas fa-home"></i>
                                    Institute
                                </a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(!empty($_GET['id']) && $_GET['id'] == 'institute-type' ? 'active' : ''); ?>"
                                    data-bs-toggle="tab" href="#instituteType" role="tab">
                                    <i class="fas fa-home"></i>
                                    Institute Type
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(!empty($_GET['id']) && $_GET['id'] == 'discipline-fee' ? 'active' : ''); ?>"
                                    data-bs-toggle="tab" href="#discipline" role="tab">
                                    <i class="fas fa-home"></i>
                                    Discipline Fee
                                </a>
                            </li>
                        ...
                        <?php if(\Request::segment(1) == 'overseas'): ?>
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(!empty($_GET['id']) && $_GET['id'] == 'overseas-type' ? 'active' : ''); ?>"
                                    data-bs-toggle="tab" href="#overseasdocumenttype" role="tab">
                                    <i class="fas fa-home"></i>
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center <?php echo e(!empty($_GET['id']) && $_GET['id'] == 'overseas-fee-structure' ? 'active' : ''); ?>"
                                    data-bs-toggle="tab" href="#overseas-fee-structure" role="tab">
                        ...
                        <?php if(\Request::segment(1) == 'polices'): ?>
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(!empty($_GET['id']) && $_GET['id'] == 'policy-category' ? 'active' : ''); ?>"
                                    data-bs-toggle="tab" href="#policy_category" role="tab">
                                    <i class="fas fa-home"></i>
                                    Policy Category
                                </a>
                            </li>
                        <?php endif; ?>
                        <?php if(\Request::segment(1) == 'pages'): ?>
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center <?php echo e(!empty($_GET['id']) && $_GET['id'] == 'home-page' ? 'active' : ''); ?>"
                        ...
                        <?php endif; ?>
                        <?php if(\Request::segment(1) == 'blogs'): ?>
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center <?php echo e(!empty($_GET['id']) && $_GET['id'] == 'home-blogs' ? 'active' : ''); ?>"
                                    data-bs-toggle="tab" href="#blogs" role="tab">
                                    <i class="las la-pager la-2x"></i>
                                    Blogs
                                </a>
                            </li>
                ...
                <div class="card-body p-4">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane <?php echo e(\Request::segment(1) == 'institutes' && empty($_GET['id']) ? 'active' : ''); ?>"
                            id="documentTypes" role="tabpanel">
                                ...
                                <div class="flex-shrink-0">
                                    <div class="form-check form-switch form-switch-right form-switch-md">
                                        <button type="button" class="btn btn-soft-info btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#save_doc_type_modal">
                                ...
                                <tbody>
                                    ...
                                    <?php $__currentLoopData = $doc_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a style="cursor:pointer" class="link-success fs-15"
                                                    tooltip="Edit Discipline"><i class="ri-edit-2-line"></i></a>
                        ...
                        <div class="tab-pane  <?php echo e(!empty($_GET['id']) && $_GET['id'] == 'overseas-type' ? 'active' : ''); ?>" id="overseas-fee-structure"
                            role="tabpanel">
                            <div class="card-header align-items-center d-flex " style="border-bottom:none !important">
                                ...
                                <div class="flex-shrink-0">
                                    <div class="form-check form-switch form-switch-right form-switch-md">
                                        <button type="button" class="btn btn-soft-info btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#overseas-fee-structure-modal">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a style="cursor:pointer" class="link-success fs-15"
                                                        ...
                                                        onclick="updateFeeStructure('<?php echo e($FeeStructure->id); ?>','<?php echo e($FeeStructure->cdd); ?>','<?php echo e($FeeStructure->fee); ?>')"><i
                            ...
                            <div class="card-header align-items-center d-flex mt-4" style="border-bottom:none !important">
                                ...
                                <div class="flex-shrink-0">
                                    <div class="form-check form-switch form-switch-right form-switch-md">
                                        <button type="button" class="btn btn-soft-info btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#overseas-fee-structure-modal2">
                                        ...
                                        <?php if($FeeStructure->currency == 'PKR'): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a style="cursor:pointer" class="link-success fs-15"
                                                        tooltip="Edit Discipline"
                                                        onclick="updateFeeStructure2('<?php echo e($FeeStructure->id); ?>','<?php echo e($FeeStructure->cdd); ?>','<?php echo e($FeeStructure->fee); ?>')"><i
                                                            class="ri-edit-2-line"></i></a>
                                                </td>
                                            </tr>
                                        <?php endif; ?>
                        ...
                        <div class="tab-pane <?php echo e(!empty($_GET['id']) && $_GET['id'] == 'institute' ? 'active' : ''); ?>"
                            id="institute" role="tabpanel">
                            ...
                            <div class="card-header align-items-center d-flex " style="border-bottom:none !important">
                                ...
                                <div class="flex-shrink-0">
                                    <div class="form-check form-switch form-switch-right form-switch-md">
                                        <button type="button" class="btn btn-soft-info btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#save_institute_modal">
                            ...
                            <table id="example"
                                class="table data-table table-bordered dt-responsive nowrap table-striped align-middle"
                                style="width:100%">
                                <thead>
                                    <tr>
                                        <th>SR No.</th>
                                ...
                                <tbody>
                                    ...
                                    <?php $__currentLoopData = $institutes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $institute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a style="cursor:pointer" class="link-success fs-15 edit-institute"
                                                    tooltip="Edit Institute" data-id=<?php echo e($institute->id); ?>

                                                    data-name="<?php echo e($institute->name); ?>"><i class="ri-edit-2-line"></i></a>
                                                <a href="delete_institute?id=<?php echo e($institute->id); ?>"
                        ...
                        <div class="tab-pane <?php echo e(!empty($_GET['id']) && $_GET['id'] == 'institute-type' ? 'active' : ''); ?>"
                            id="instituteType" role="tabpanel">
                            <div class="card-header align-items-center d-flex " style="border-bottom:none !important">
                                <h4 class="card-title mb-0 flex-grow-1"></h4>
                                <div class="flex-shrink-0">
                                    <div class="form-check form-switch form-switch-right form-switch-md">
                                        <button type="button" class="btn btn-soft-info btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#save_institute_type_modal">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a style="cursor:pointer" class="link-success fs-15 edit-institute-type""
                                                    tooltip=" Edit Institute Type" data-id=<?php echo e($type->id); ?>

                                                    data-name="<?php echo e($type->type); ?>"><i class="ri-edit-2-line"></i></a>
                                                

                                                <a href="/delete_institute_type?id=<?php echo e($type->id); ?>"
                                                    class="link-danger fs-15"><i class="ri-delete-bin-line"></i></a>
                                            </td>
                                        </tr>
                                        <?php
                        ...
                        <div class="tab-pane <?php echo e(empty($_GET['id']) ? 'active' : ''); ?>"
                            id="overseasdocumenttype" role="tabpanel">
                            <div class="card-header align-items-center d-flex " style="border-bottom:none !important">
                                <h4 class="card-title mb-0 flex-grow-1"></h4>
                                <div class="flex-shrink-0">
                                    <div class="form-check form-switch form-switch-right form-switch-md">
                                        <button type="button" class="btn btn-soft-info btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#save_overseas_document_type_modal">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a style="cursor:pointer"
                                                    class="link-success fs-15 edit-overseas-document-type"
                                                    tooltip=" Edit Overseas Document Type" data-id=<?php echo e($type->id); ?>

                                                    data-name="<?php echo e($type->type); ?>" data-fee="<?php echo e($type->fee); ?>"><i
                                                        class="ri-edit-2-line"></i></a>

                                                <a href="/delete_overseas_document_type?id=<?php echo e($type->id); ?>"
                                                    class="link-danger fs-15"><i class="ri-delete-bin-line"></i></a>
                                            </td>
                                        </tr>
                                        <?php
                        ...
                        <div class="tab-pane <?php echo e(!empty($_GET['id']) && $_GET['id'] == 'discipline-fee' ? 'active' : ''); ?>"
                            id="discipline" role="tabpanel">
                            ...
                            <div class="card-header align-items-center d-flex " style="border-bottom:none !important">
                                ...
                                <div class="flex-shrink-0">
                                    <div class="form-check form-switch form-switch-right form-switch-md">
                                        <button type="button" class="btn btn-soft-info btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#save_discipline_modal">
                                    ...
                                    <?php $__currentLoopData = $disciplines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $discipline): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="/delete_discipline_fee?id=<?php echo e($discipline->id); ?>"
                                                    class="link-danger fs-15"><i class="ri-delete-bin-line"></i></a>
                                            </td>
                                        </tr>
                                        <?php
                        ...
                        <div class="tab-pane <?php echo e(\Request::segment(1) == 'polices' ? 'active' : ''); ?>"
                            id="policy_category" role="tabpanel">
                            ...
                            <div class="card-header align-items-center d-flex " style="border-bottom:none !important">
                                ...
                                <div class="flex-shrink-0">
                                    <div class="form-check form-switch form-switch-right form-switch-md">
                                        <button type="button" class="btn btn-soft-info btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#save_policy_category_modal">
                                ...
                                <tbody>
                                    ...
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a style="cursor:pointer" class="link-success fs-15 edit-policy-category"
                                                    tooltip="Edit Policy Category" data-id='<?php echo e($category->id); ?>'
                                                    data-policy='<?php echo e($category->category); ?>'><i
                                                        class="ri-edit-2-line"></i></a>

                                                <a href="/delete-policy-category?id=<?php echo e($category->id); ?>"
                                                    class="link-danger fs-15"><i class="ri-delete-bin-line"></i></a>
                                            </td>
                                        </tr>
                                        <?php
                        ...
                        <div class="tab-pane <?php echo e(\Request::segment(1) == 'pages' ? 'active' : ''); ?>" id="Pages"
                            role="tabpanel">
                            
                            <div class="accordion" id="accordionPanelsStayOpenExample">
                                <div class="accordion-item mb-5">
                                    <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                        <button class="accordion-button" style="background-color: rgb(241, 241, 241);"
                                    ...
                                    <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show"
                                        ...
                                        <form action="<?php echo e(route('dynamic_pages_slider')); ?>" method="post"
                                            ...
                                            <div class="accordion-body">
                                                <div class="col-lg-6 mb-2">
                                                    <div>
                                                        ...
                                                        <input type="file" name="slider_image1" class="form-control"
                                                            placeholder="Slider" required />
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 mb-2">
                                                    <div>
                                                        <label for="orderId" class="form-label">Slider 2</label>
                                                        <input type="file" name="slider_image2" class="form-control"
                                                            placeholder="Slider" />
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 mb-4">
                                                    <div>
                                                        ...
                                                        <input type="file" name="slider_image3" class="form-control"
                                                            placeholder="Slider" />
                                                    </div>
                                                </div>
                                                <div class="col-lg-3 my-2">
                                                    <div>
                                                        <button type="submit"
                                                            class="btn btn-success px-4 py-2">Save</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                                ...
                                <div class="accordion-item mb-5">
                                    <h2 class="accordion-header" id="panelsStayOpen-headingTwo">
                                        <button class="accordion-button collapsed"
                                            style="background-color: rgb(241, 241, 241);" type="button"
                        ...
                        <div class="tab-pane <?php echo e(\Request::segment(1) == 'blogs' ? 'active' : ''); ?>" id="blogs"
                            role="tabpanel">
                            ...
                            <div class="card-header align-items-center d-flex " style="border-bottom:none !important">
                                ...
                                <div class="flex-shrink-0">
                                    <div class="form-check form-switch form-switch-right form-switch-md">
                                        ...
                                        <button type="button" class="btn btn-soft-info btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#save_post_type_modal">
                                    ...
                                    <?php $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <p class="fullDescription" style="display: none;">
                                                    <?php echo e($blog->short_description); ?></p>
                                                <a href="#" class="readMoreLink">Read more</a>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn qualification"
                                                    onclick="UpdateSubject('<?php echo e($blog->id); ?>', '<?php echo e($blog->description); ?>', '<?php echo e($blog->short_description); ?>', '<?php echo e($blog->feature_image); ?>', '<?php echo e($blog->related_image1); ?>', '<?php echo e($blog->related_image2); ?>','<?php echo e($blog->title); ?>')">
                                                    <i class="fa-solid fa-edit"></i>
                                                </a>
                                                <a href="<?php echo e(url('/delectblog?id=') . $blog->id); ?>"
                                                    class="link-danger fs-15"><i class="ri-delete-bin-line"></i></a>
                                            </td>
                                        </tr>
                                        <?php
                            ...
                            <div class="card-header align-items-center d-flex " style="border-bottom:none !important">
                                ...
                                <div class="flex-shrink-0">
                                    <div class="form-check form-switch form-switch-right form-switch-md">
                                        ...
                                        <button type="button" class="btn btn-soft-info btn-sm" data-bs-toggle="modal"
                                            data-bs-target="#save_artical_type_modal">
    ...
    <div class="modal fade zoomIn" id="overseas-fee-structure-modal" tabindex="-1"
        aria-labelledby="overseas-fee-structure-modal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                ...
                <form class="tablelist-form" id="save_fee_structure_form" autocomplete="off"
                    action="<?php echo e(route('save_fee_structure')); ?>">
                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="row col-md-12 justify-content-center">
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" id="cdd" name="cdd"
                                                    value="1 Year" type="radio">
    ...
    <div class="modal fade zoomIn" id="overseas-fee-structure-modal2" tabindex="-1"
        aria-labelledby="overseas-fee-structure-modal2" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                <div class="modal-header p-3 bg-info-subtle">
                ...
                <form class="tablelist-form" id="save_fee_structure_form2" autocomplete="off"
                    action="<?php echo e(route('save_fee_structure')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="row g-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row col-md-12 justify-content-center">
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" id="cdd" name="cdd"
                                                    value="Certificate Holders One Year" type="radio">
                                        ...
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" id="cdd" name="cdd"
                                                    value="Certificate Holders Two Year" type="radio">
                                        ...
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" id="cdd" name="cdd"
                                                    value="Certificate Holders Five Year" type="radio">
                                    ...
                                    <div class="row col-md-12 justify-content-center">
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" id="cdd" name="cdd"
                                                    value="Diploma Holders One Year" type="radio">
                                                <label class="form-check-label">One Year</label>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" id="cdd" name="cdd"
                                                    value="Diploma Holders Two Year" type="radio">
                                                <label class="form-check-label">Two Year</label>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" id="cdd" name="cdd"
                                                    value="Diploma Holders Five Year" type="radio">
                                                <label class="form-check-label">Five Year</label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row col-md-12 justify-content-center">
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" id="cdd" name="cdd"
                                                    value="Degree Holders One Year" type="radio">
                                                <label class="form-check-label">One Year</label>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" id="cdd" name="cdd"
                                                    value="Degree Holders Two Year" type="radio">
                                                <label class="form-check-label">Two Year</label>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" id="cdd" name="cdd"
                                                    value="Degree Holders Five Year" type="radio">
                                                <label class="form-check-label">Five Year</label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row col-md-12 justify-content-center">
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" id="cdd" name="cdd"
                                                    value="Post Doc One Year" type="radio">
                                                <label class="form-check-label">One Year</label>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" id="cdd" name="cdd"
                                                    value="Post Doc Two Year" type="radio">
                                                <label class="form-check-label">Two Year</label>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" id="cdd" name="cdd"
                                                    value="Post Doc Five Year" type="radio">
                                                <label class="form-check-label">Five Year</label>
                                            </div>
                                        </div>
                                        <input type="hidden" name="edit" value="">
                            ...
                            <div class="col-lg-12">
                                <div>
                                    <label for="orderId" class="form-label">Fee</label>
                                    <input type="text" id="fee2" name="fee" class="form-control"
                                        placeholder="Title" required />
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal fade zoomIn" id="save_doc_type_modal" tabindex="-1" aria-labelledby="save_doc_type_modal"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                ...
                <form class="tablelist-form" id="save_doc_type_form" autocomplete="off"
                    action="<?php echo e(route('save_document_types')); ?>">
                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-lg-12">
                                <div>
                                    <label for="orderId" class="form-label">Document Title</label>
                                    <input type="text" id="doc_name" class="form-control" placeholder="Title"
                                        required />
                                </div>
                            </div>
                            <div class="col-lg-12">
                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = $institute_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <div class="form-check">
                                                    <input class="form-check-input" name="institute_type"
                                                        value="<?php echo e(strtolower($type->type)); ?>" type="radio">
                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = $institutes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $institute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <div class="form-check">
                                                    <input class="form-check-input" name="institute"
                                                        value="<?php echo e(strtolower($institute->name)); ?>" type="radio"
                                                        checked>
    ...
    <div class="modal fade zoomIn" id="save_overseas_document_type_modal" tabindex="-1"
        aria-labelledby="save_doc_type_modal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                <div class="modal-header p-3 bg-info-subtle">
                ...
                <form class="tablelist-form" id="save_doc_type_form" autocomplete="off"
                    action="<?php echo e(route('save_overseas_document_type')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-lg-12">
                                <div>
                                    ...
                                    <input type="text" id="overseas-document-type-name" name="name"
                            ...
                            <div class="col-lg-12">
                                <div>
                                    <label for="orderId" class="form-label">Fee</label>
                                    <input type="text" id="overseas-document-type-fee" name="fee"
                                        class="form-control" placeholder="Fee" required />
                                </div>
                            </div>
                    ...
                    <div class="modal-footer">
                        <div class="hstack gap-2 justify-content-end">
                            <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
                            <button type="submit" class="btn btn-success" name="add_btn"
                                id="overseas-document-type-add-btn">Add</button>
    ...
    <div class="modal fade zoomIn" id="save_institute_modal" tabindex="-1" aria-labelledby="save_doc_type_modal"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                <div class="modal-header p-3 bg-info-subtle">
                ...
                <form class="tablelist-form" id="save_doc_type_form" autocomplete="off"
                    action="<?php echo e(route('save_institute')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-lg-12">
                    ...
                    <div class="modal-footer">
                        <div class="hstack gap-2 justify-content-end">
                            <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
                            <button type="submit" class="btn btn-success" name="add_btn"
                                id="institute-add-btn">Add</button>
    ...
    <div class="modal fade zoomIn" id="save_institute_type_modal" tabindex="-1" aria-labelledby="save_doc_type_modal"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                <div class="modal-header p-3 bg-info-subtle">
                ...
                <form class="tablelist-form" id="save_doc_type_form" autocomplete="off"
                    action="<?php echo e(route('save_institute_type')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-lg-12">
                    ...
                    <div class="modal-footer">
                        <div class="hstack gap-2 justify-content-end">
                            <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
                            <button type="submit" class="btn btn-success" name="add_btn"
                                id="institute-type-add-btn">Add</button>
    ...
    <div class="modal fade zoomIn" id="edit_dsicipline_modal" tabindex="-1" aria-labelledby="save_doc_type_modal"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                <div class="modal-header p-3 bg-info-subtle">
                ...
                <form class="tablelist-form" id="save_doc_type_form" autocomplete="off"
                    action="<?php echo e(route('edit_discipline')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-lg-12">
                                <div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="" name="amount" value=""
                                            id="discipline_amount" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $institute_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <div class="form-check">
                                            <input class="form-check-input" name="institute_type"
                                                value="<?php echo e(strtolower($type->type)); ?>" type="radio" required>
                                            <label class="form-check-label"><?php echo e($type->type); ?></label>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <?php endif; ?>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $institutes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $institute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <div class="form-check">
                                            <input class="form-check-input" name="institute"
                                                value="<?php echo e(strtolower($institute->name)); ?>" type="radio" required>
                                            <label class="form-check-label"><?php echo e($institute->name); ?></label>
                                        </div>
                    ...
                    <div class="modal-footer">
                        <div class="hstack gap-2 justify-content-end">
                            <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
                            <button type="submit" class="btn btn-success" name="update_btn"
                                id="">Update</button>
    ...
    <div class="modal fade" id="save_discipline_modal" tabindex="-1" aria-labelledby="save_doc_type_modal"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                <div class="modal-header p-3 bg-info-subtle">
                ...
                <form class="tablelist-form" id="save_doc_type_form" autocomplete="off"
                    action="<?php echo e(route('edit_discipline_amount')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                    ...
                                    <select name="discipline_id" id="" class="form form-control">
                                        ...
                                        <?php $__currentLoopData = $disciplines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $discipline): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <option value="<?php echo e($discipline->id); ?>">
                                                <?php echo e($discipline->discipline_name . '-' . $discipline->institute_type . '-' . $discipline->institute); ?>
    ...
    <div class="modal fade" id="save_policy_category_modal" tabindex="-1" aria-labelledby="save_doc_type_modal"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0">
                ...
                <form class="tablelist-form" id="save_doc_type_form" autocomplete="off"
                    action="<?php echo e(route('add_policy_category')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="category" value=""
                                        class="form form-control policy_category">
                    ...
                    <div class="modal-footer">
                        <div class="hstack gap-2 justify-content-end">
                            <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
                            <button type="submit" class="btn btn-success add-policy-btn" name="add_btn"
                                id="">Add</button>
                        </div>
                    </div>
                </form>
    ...
    <div class="modal fade zoomIn" id="save_post_type_modal" tabindex="-1" aria-labelledby="save_post_type_modal"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                <div class="modal-header p-3 bg-info-subtle">
                ...
                <form class="tablelist-form" method="post" enctype="multipart/form-data" id="save_post_type_form"
                    action="<?php echo e(route('postsh')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-lg-12">
                            ...
                            <div class="col-lg-12">
                                <div>
                                    ...
                                    <textarea class="form-control" name="short_description" id="shortdescription"
                                        placeholder="Enter your Short description" rows="3"></textarea>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div>
                                    <label for="orderId" class="form-label">Related Image</label>
                                    <input type="file" name="related_image1" class="form-control"
                                        placeholder="Related Image" required />
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div>
                                    <label for="orderId" class="form-label">Related Image</label>
                                    <input type="file" name="related_image2" class="form-control"
                                        placeholder="Related Image" required />
                                </div>
                            </div>
    ...
    <div class="modal fade zoomIn" id="save_artical_type_modal" tabindex="-1"
        aria-labelledby="save_artical_type_modal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                <div class="modal-header p-3 bg-info-subtle">
                ...
                <form class="tablelist-form" method="post" id="save_artical_type_form"
                    action="<?php echo e(route('artical')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="row g-3">
