    ...
    <div class="layout-width">
        <div class="navbar-header">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="ms-1 header-item d-none d-sm-flex">
                    <a type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" href="/">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            ...
                            <img class="rounded-circle header-profile-user" src="<?php if(Auth::user()->avatar != ''): ?> <?php echo e(URL::asset(Auth::user()->avatar)); ?><?php else: ?><?php echo e(URL::asset('build/images/users/inst.png')); ?> <?php endif; ?>" alt="Header Avatar">
                            <?php else: ?>
                            <img class="rounded-circle header-profile-user" src="<?php if(Auth::user()->avatar != ''): ?> <?php echo e(URL::asset(Auth::user()->avatar)); ?><?php else: ?><?php echo e(URL::asset('build/images/users/user-dummy-img.jpg')); ?> <?php endif; ?>" alt="Header Avatar">
                            <?php endif; ?>
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text"><?php echo e(\Auth::user()->first_name); ?></span>
                            <?php if(Auth::user()->role_id == 2): ?>
                                <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text"><?php echo e(\Auth::user()->institute_type); ?></span>
                            <?php endif; ?>
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <?php if(\Auth::user()->role_id == 2): ?>
                        <a class="dropdown-item" href="/institute_profile"><i class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Profile</span></a>
                        <?php else: ?>
...
<?php /**PATH /home/admin/public_html/ahpc.smarttechnologyhouse.net/resources/views/layouts/topbar.blade.php ENDPATH**/ ?>