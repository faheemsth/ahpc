...
<div class="row py-5 justify-content-center">
    <div class="col-md-10 col-12">
        <div class=" con-img py-4 text-center">
            <img src="<?php echo e(asset('build/images/illustrations-webmaintenance.png')); ?>" height="auto">
        </div>
...
<?php echo $__env->make('site.sitelayout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/public_html/ahpc.smarttechnologyhouse.net/resources/views/site/Maintenance.blade.php ENDPATH**/ ?>