...
<?php $__env->startSection('content'); ?>
    ...
    margin: 20px 0;">
                <form class="form-horizontal" action="<?php echo e(route('ahpc.store')); ?>" id="multistep_form" method="POST"
                                    ...
                                    <div>
                                        <div class="row col-3 col-md-2 m-auto mb-5">
                                            <input type="button" style="background-color:#009245; color: #FFF;"
                                                class="next btn mt-5" value="Next" id="next1" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <select class="form-select">
                                            <?php if(!empty($FeeStructures)): ?>
                                                <?php $__currentLoopData = $FeeStructures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $FeeStructure): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($FeeStructure->fee); ?>"><?php echo e($FeeStructure->cdd); ?>
                            ...
                            <div class="form-group">
                                <div class="row col-md-12 justify-content-center">
                                    ...
                                    <div class="mb-3 col-md-3">
                                        ...
                                        <input type="text" class="form-control" value=""
                                            placeholder="+92 xxx xxxxxxx" name="contact_no">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                    ...
                                    <div class="col-md-6 text-center">
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                ...
                                                hidden from the authority. If any information / act found false /
                                                objectionable, at later stage the Council reserves the right to take legal
                                                action against me.
                                            </label>
                                        </div>
                                    </div>
...
<?php echo $__env->make('site.sitelayout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/public_html/ahpc.smarttechnologyhouse.net/resources/views/site/ahpcsignup.blade.php ENDPATH**/ ?>