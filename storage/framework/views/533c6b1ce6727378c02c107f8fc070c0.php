        ...
        <div style="background-color:#005d32;" class="container text-md-left">
          <div class="row">
            <div class="col-md-6 col-lg-4 text-start">
              <!-- Content -->
              <a href="<?php echo e(route('site.home')); ?>" class="text-decoration-none d-flex align-items-center gap-2">
                <img src="<?php echo e(asset('build/images/siteimages/ahpc logo png.png')); ?>" alt="" srcset="">
            ...
            <div id="link10" class="col-md-6 col-lg-2 col-xl-2 mx-auto mb-4 justify-content-start">
              ...
              <p>
                <a href="<?php echo e(url('/maintenance')); ?>">Blog</a>
              </p>
              <p>
                <a href="<?php echo e(url('/maintenance')); ?>">FAQ's</a>
              </p>
              <p>
                <a href="<?php echo e(url('/maintenance')); ?>">Private & Policy</a>
              </p>
              <p>
                <a href="<?php echo e(url('/maintenance')); ?>">Terms & Conditions</a>
              </p>
            </div>
            <hr class="clearfix w-100 d-md-none">
            <div id="link10" class="col-md-6 col-lg-2 col-xl-2 mx-auto mb-4 justify-content-start">
              ...
              <p>
                <a href="<?php echo e(url('/login')); ?>">Your Account</a>
              </p>
              <p>
                <a href="<?php echo e(url('/maintenance')); ?>">Check Registration</a>
              </p>
              <p>
                <a href="<?php echo e(url('/member/list')); ?>">Members</a>
              </p>
              <p>
                <a href="<?php echo e(url('/maintenance')); ?>">Help</a>
              </p>
            </div>
    ...
    <!-- end footer  -->
<?php /**PATH /home/admin/public_html/ahpc.smarttechnologyhouse.net/resources/views/site/sitelayout/sitefooter.blade.php ENDPATH**/ ?>