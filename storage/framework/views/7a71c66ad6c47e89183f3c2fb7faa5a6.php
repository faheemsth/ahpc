                    ...
                    <div class="text-center mt-sm-5 mb-4 text-white-50">
                        <div>
                            <a href="index" class="d-inline-block auth-logo">
                                <img src="<?php echo e(URL::asset('build/images/ahpc logo png.png')); ?>" alt="" with="60%">
                            </a>
                        </div>
                        <p class="mt-3 fs-15 fw-medium"> Allied Health Professionals Council - AHPC (Govt. of Pakistan) </p>
                    </div>
                </div>
            </div>
            <!-- end row -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        <p class="mb-0 text-muted">&copy; <script>document.write(new Date().getFullYear())</script> . Crafted with <i class="mdi mdi-heart text-danger"></i> by STH</p>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/public_html/ahpc.smarttechnologyhouse.net/resources/views/auth/login.blade.php ENDPATH**/ ?>