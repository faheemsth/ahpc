            ...
            <div class="card">
                <div class="card-header">
                    <ul class="nav nav-tabs-custom rounded card-header-tabs border-bottom-0" role="tablist">
                        @if (\Request::segment(1) == 'institutes')
                            <li class="nav-item">
                                <a class="nav-link {{ !empty($_GET['id']) ? '' : 'active' }}" data-bs-toggle="tab"
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ !empty($_GET['id']) && $_GET['id'] == 'institute' ? 'active' : '' }}"
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ !empty($_GET['id']) && $_GET['id'] == 'institute-type' ? 'active' : '' }}"
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ !empty($_GET['id']) && $_GET['id'] == 'discipline-fee' ? 'active' : '' }}"
                        ...
                        @if (\Request::segment(1) == 'overseas')
                            <li class="nav-item">
                                <a class="nav-link {{ !empty($_GET['id']) && $_GET['id'] == 'overseas-type' ? 'active' : '' }}"
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center {{ !empty($_GET['id']) && $_GET['id'] == 'overseas-fee-structure' ? 'active' : '' }}"
                        ...
                        @if (\Request::segment(1) == 'polices')
                            <li class="nav-item">
                                <a class="nav-link {{ !empty($_GET['id']) && $_GET['id'] == 'policy-category' ? 'active' : '' }}"
                        ...
                        @if (\Request::segment(1) == 'pages')
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center {{ !empty($_GET['id']) && $_GET['id'] == 'home-page' ? 'active' : '' }}"
                        ...
                        @if (\Request::segment(1) == 'blogs')
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center {{ !empty($_GET['id']) && $_GET['id'] == 'home-blogs' ? 'active' : '' }}"
                ...
                <div class="card-body p-4">
                    <div class="tab-content">
                        {{--  --}}
                        <div class="tab-pane {{ \Request::segment(1) == 'institutes' && empty($_GET['id']) ? 'active' : '' }}"
                        ...
                        {{--  --}}
                        <div class="tab-pane  {{ !empty($_GET['id']) && $_GET['id'] == 'overseas-type' ? 'active' : '' }}" id="overseas-fee-structure"
                            role="tabpanel">
                            <div class="card-header align-items-center d-flex " style="border-bottom:none !important">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a style="cursor:pointer" class="link-success fs-15"
                                                        ...
                                                        onclick="updateFeeStructure('{{ $FeeStructure->id }}','{{ $FeeStructure->cdd }}','{{ $FeeStructure->fee }}')"><i
                                        ...
                                        @if ($FeeStructure->currency == 'PKR')
                                            <tr>
                                                ...
                                                <td>
                                                    <a style="cursor:pointer" class="link-success fs-15"
                                                        tooltip="Edit Discipline"
                                                        onclick="updateFeeStructure2('{{ $FeeStructure->id }}','{{ $FeeStructure->cdd }}','{{ $FeeStructure->fee }}')"><i
                                                            class="ri-edit-2-line"></i></a>
                                                </td>
                                            </tr>
                                        @endif
                        ...
                        <div class="tab-pane {{ !empty($_GET['id']) && $_GET['id'] == 'institute' ? 'active' : '' }}"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a style="cursor:pointer" class="link-success fs-15 edit-institute"
                                                    tooltip="Edit Institute" data-id={{ $institute->id }}
                                                    data-name="{{ $institute->name }}"><i class="ri-edit-2-line"></i></a>
                                                <a href="delete_institute?id={{ $institute->id }}"
                        ...
                        <div class="tab-pane {{ !empty($_GET['id']) && $_GET['id'] == 'institute-type' ? 'active' : '' }}"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a style="cursor:pointer" class="link-success fs-15 edit-institute-type""
                                                    tooltip=" Edit Institute Type" data-id={{ $type->id }}
                                                    data-name="{{ $type->type }}"><i class="ri-edit-2-line"></i></a>
                                                {{-- <a style="cursor:pointer" class="link-success fs-15" tooltip="Add Program"><i class="ri-layout-2-fill"></i></a> --}}

                                                <a href="/delete_institute_type?id={{ $type->id }}"
                                                    class="link-danger fs-15"><i class="ri-delete-bin-line"></i></a>
                                            </td>
                                        </tr>
                                        @php
                        ...
                        <div class="tab-pane {{ empty($_GET['id']) ? 'active' : '' }}"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a style="cursor:pointer"
                                                    ...
                                                    tooltip=" Edit Overseas Document Type" data-id={{ $type->id }}
                                                    data-name="{{ $type->type }}" data-fee="{{ $type->fee }}"><i
                                                        class="ri-edit-2-line"></i></a>

                                                <a href="/delete_overseas_document_type?id={{ $type->id }}"
                                                    class="link-danger fs-15"><i class="ri-delete-bin-line"></i></a>
                                            </td>
                                        </tr>
                                        @php
                        ...
                        <div class="tab-pane {{ !empty($_GET['id']) && $_GET['id'] == 'discipline-fee' ? 'active' : '' }}"
                                    ...
                                    @foreach ($disciplines as $discipline)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="/delete_discipline_fee?id={{ $discipline->id }}"
                                                    class="link-danger fs-15"><i class="ri-delete-bin-line"></i></a>
                                            </td>
                                        </tr>
                                        @php
                        ...
                        <div class="tab-pane {{ \Request::segment(1) == 'polices' ? 'active' : '' }}"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a style="cursor:pointer" class="link-success fs-15 edit-policy-category"
                                                    tooltip="Edit Policy Category" data-id='{{ $category->id }}'
                                                    data-policy='{{ $category->category }}'><i
                                                        class="ri-edit-2-line"></i></a>

                                                <a href="/delete-policy-category?id={{ $category->id }}"
                                                    class="link-danger fs-15"><i class="ri-delete-bin-line"></i></a>
                                            </td>
                                        </tr>
                                        @php
                        ...
                        <div class="tab-pane {{ \Request::segment(1) == 'pages' ? 'active' : '' }}" id="Pages"
                            role="tabpanel">
                            ...
                            <div class="accordion" id="accordionPanelsStayOpenExample">
                                <div class="accordion-item mb-5">
                                    ...
                                    <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show"
                                        ...
                                        <form action="{{ route('dynamic_pages_slider') }}" method="post"
                        ...
                        <div class="tab-pane {{ \Request::segment(1) == 'blogs' ? 'active' : '' }}" id="blogs"
                            role="tabpanel">
                            {{-- <form>
                                <div id="newlink">
                                    <div id="1">
                        ...
                        onclick="updateBlog({{ $blog->id }},'',{{ $blog->description }},''{{ $blog->short_description }},'',{{ $blog->feature_image }},'',{{ $blog->related_image1 }},'',{{ $blog->related_image2 }})",
                                        href="javascript:void(0);" class="link-success fs-15" tooltip="Edit Discipline"><i class="ri-edit-2-line"></i></a> --}}
                                                ...
                                                <a class="btn qualification"
                                                    onclick="UpdateSubject('{{ $blog->id }}', '{{ $blog->description }}', '{{ $blog->short_description }}', '{{ $blog->feature_image }}', '{{ $blog->related_image1 }}', '{{ $blog->related_image2 }}','{{ $blog->title }}')">
                                                    <i class="fa-solid fa-edit"></i>
                                                </a>
                                                <a href="{{ url('/delectblog?id=') . $blog->id }}"
                                                    class="link-danger fs-15"><i class="ri-delete-bin-line"></i></a>
                                            </td>
                                        </tr>
                                        @php
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                ...
                <form class="tablelist-form" id="save_fee_structure_form" autocomplete="off"
                    action="{{ route('save_fee_structure') }}">
                    @csrf
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                ...
                <form class="tablelist-form" id="save_doc_type_form" autocomplete="off"
                    action="{{ route('save_document_types') }}">
                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-lg-12">
                                <div>
                                            ...
                                            @forelse ($institute_types as $type)
                                                <div class="form-check">
                                                    <input class="form-check-input" name="institute_type"
                                                        value="{{ strtolower($type->type) }}" type="radio">
                                            ...
                                            @forelse ($institutes as $institute)
                                                <div class="form-check">
                                                    <input class="form-check-input" name="institute"
                                                        value="{{ strtolower($institute->name) }}" type="radio"
                                                        checked>
    ...
    <div class="modal fade zoomIn" id="save_overseas_document_type_modal" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                ...
                <form class="tablelist-form" id="save_doc_type_form" autocomplete="off"
                    action="{{ route('save_overseas_document_type') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-lg-12">
    ...
    <div class="modal fade zoomIn" id="save_institute_modal" tabindex="-1" aria-labelledby="save_doc_type_modal"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                ...
                <form class="tablelist-form" id="save_doc_type_form" autocomplete="off"
                    action="{{ route('save_institute') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-lg-12">
    ...
    <div class="modal fade zoomIn" id="save_institute_type_modal" tabindex="-1" aria-labelledby="save_doc_type_modal"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                ...
                <form class="tablelist-form" id="save_doc_type_form" autocomplete="off"
                    action="{{ route('save_institute_type') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-lg-12">
    ...
    <div class="modal fade zoomIn" id="edit_dsicipline_modal" tabindex="-1" aria-labelledby="save_doc_type_modal"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                ...
                <form class="tablelist-form" id="save_doc_type_form" autocomplete="off"
                    action="{{ route('edit_discipline') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-lg-12">
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    @forelse ($institute_types as $type)
                                        <div class="form-check">
                                            <input class="form-check-input" name="institute_type"
                                                value="{{ strtolower($type->type) }}" type="radio" required>
                                            <label class="form-check-label">{{ $type->type }}</label>
                                        </div>
                                    @empty
                                    @endforelse
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    @forelse ($institutes as $institute)
                                        <div class="form-check">
                                            <input class="form-check-input" name="institute"
                                                value="{{ strtolower($institute->name) }}" type="radio" required>
                                            <label class="form-check-label">{{ $institute->name }}</label>
                                        </div>
    ...
    <div class="modal fade" id="save_discipline_modal" tabindex="-1" aria-labelledby="save_doc_type_modal"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                ...
                <form class="tablelist-form" id="save_doc_type_form" autocomplete="off"
                    action="{{ route('edit_discipline_amount') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                                    ...
                                    <select name="discipline_id" id="" class="form form-control">
                                        ...
                                        @foreach ($disciplines as $key => $discipline)
                                            ...
                                            <option value="{{ $discipline->id }}">
                                                {{ $discipline->discipline_name . '-' . $discipline->institute_type . '-' . $discipline->institute }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
    ...
    <div class="modal fade" id="save_policy_category_modal" tabindex="-1" aria-labelledby="save_doc_type_modal"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0">
                ...
                <form class="tablelist-form" id="save_doc_type_form" autocomplete="off"
                    action="{{ route('add_policy_category') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-md-12">
