                        ...
                        <li class="nav-item">
                            <a class="nav-link fs-14" data-bs-toggle="tab" href="#projects" role="tab">
                                <i class="ri-price-tag-line d-inline-block d-md-none"></i> <span
                                    class="d-none d-md-inline-block">Programs</span>
                            </a>
                        </li>
                        <li class="nav-item">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex flex-wrap gap-2 fs-16">
                                            ...
                                            <a href="javascript:void(0);" class="badge bg-primary-subtle text-primary">{{$discipline->discipline_name}}</a>
                                            @endforeach
                                        </div>
                                    </div><!-- end card body -->
                                </div><!-- end card -->
                                            ...
                                            <div class="col-6 col-md-4">
                                                <div class="d-flex mt-4">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        ...
                                                        <h6 class="text-truncate mb-0">{{ucfirst(\Auth::user()->institute)}}/{{ucfirst(\Auth::user()->institute_type)}}</h6>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--end col-->
                                            <div class="col-6 col-md-4">
                                                <div class="d-flex mt-4">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        ...
                                                        <a href="#" class="fw-semibold">{{\Auth::user()->website_url}}</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--end col-->
                                ...
                                <div class="acitivity-timeline">
                                    ...
                                    <div class="acitivity-item py-3 d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <small class="mb-0 text-muted">{{ \Carbon\Carbon::parse($log->created_at)->format('j F Y') }}</small>
                                        </div>
                                    </div>
                                    @endforeach
                                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                        ...
                                        <div class="col-xxl-4 col-sm-6">
                                            <div class="card profile-project-card shadow-none profile-project-warning">
                                                <div class="card-body p-4">
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1 text-muted overflow-hidden">
                                                            <h5 class="fs-15 mb-0 text-truncate task-title"><a href="#"
                                                                    class="text-body">{{$discipline->discipline_name}}</a>
                                                            </h5>
                                                        </div>
                                                    </div>
                                                                        ...
                                                                        <ul class=" ps-3 list-unstyled vstack gap-2">
                                                                            @foreach($discipline->programs as $program)
                                                                                ...
                                                                                @foreach($inst_prgs as $inst_prg)
                                                                                    @if($inst_prg->program_id ==  $program->id)
                                                                                        @php
                                                                                            $chek = 'checked';
                                                                                ...
                                                                                <li>
                                                                                    <div class="form-check">
                                                                                        <input class="form-check-input" name="programs" type="checkbox" value="{{$program->id}}" id="program_{{$program->id}}" {{$chek}} {{$readonly}}>
                                                                                        <label class="form-check-label" for="program_{{$program->id}}">
                                                                                            {{$program->title}} <a href="javascript:void(0);" class="{{$status}}">{{$status_name}}</a>
                                                                                        </label>
                                                                                    </div>
                                                                                </li>
                                                                            @endforeach
                                    ...
                                    @endforeach
                                    <div class="flex-shrink-0" style="text-align:end">
                                        <a onclick="updatePrograms()" class="btn btn-success"><i class="ri-edit-box-line align-bottom"></i> Save</a>
                                    </div>
                                </div>
                                <!--end row-->
                            </div>
                                            ...
                                            <table class="table table-borderless align-middle mb-0">
                                                ...
                                                @endphp
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if(isset($doc_type->documents))
                                                                @foreach($doc_type->documents as $doc)
                                                                    @php
                                                                        $status = $doc->status;
                                                                        $description = $doc->description != NULL ? $doc->description : '---';

                                                                    @endphp
                                                                    <a download href="{{ asset('storage/institute_documents/'.\Auth::user()->id) }}/{{$doc->file}}" style="width:50px;height:50px" class="document_img"> 
                                                                        <i class="ri-download-line image_download_icon"></i>
                                                                        {{-- <div style="position: relative;width:100%:height:100%" class="backdrop"></div> --}}
                                                                        <img style="width:50px;height:50px" src="{{ asset('storage/institute_documents/'.\Auth::user()->id) }}/{{$doc->file}}">
                                                                    </a>
                                                        ...
                                                        <td>{{$description}}</td>
                                                        <td>
                                                            <a style="cursor:pointer" onClick="addDoc(`{{$doc_type->title}}`)" class="link-success fs-20" tooltip="Add File"><i class="ri-file-add-line"></i></a>
                                                        </td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
