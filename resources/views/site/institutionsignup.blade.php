                                    ...
                                    <div class="form-group">
                                        <div class="row col-md-12 justify-content-center">
                                            <div class="mb-3 col-md-6" style="width:25% !important">
                                                ...
                                                {{-- <label class="form-label">Number of Allied Health Disciplines offered by
                                                    the Institute/university Administrative Control:</label> --}}


                                                @forelse ($Types as $key => $type)
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="institute_type"
                                                            id="institute-type-v1" value="{{ $type->type }}"
                                                            type="radio">
                                            ...
                                            <div class="mb-3 col-md-6" style="width:25% !important">
                                                @forelse ($Institutes as $key => $institute)
                                                    <label class="form-label"></label>
                                                    <div class="form-check">
                                                        <input class="form-check-input" name="institute"
                                                            id="institute-v1" value="{{ $institute->name }}"
                                                            type="radio">
                                                ...
                                                @if (!empty($Disciplines))
                                                    @foreach ($Disciplines as $Discipline)
                                                        <li class="item">
                                                            ...
                                                            <span class="item-text" data-token="{{ $Discipline->id }}"
                                                                data-amt={{ $Discipline->amount }}
                                                                data-text="{{ $Discipline->discipline_name }}">{{ $Discipline->discipline_name }}</span>
                                                        </li>
                                                    @endforeach
                                                @endif
                                            </ul>
                            ...
                            <div class="container">
                                <div class="row col-md-12 justify-content-center">
                                    <div class="col-md-6 text-center">
                                        {{-- <input type="file" name="profile" id="profile" class="mb-2"> --}}
