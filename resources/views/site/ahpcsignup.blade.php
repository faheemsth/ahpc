...
@section('content')
    ...
    margin: 20px 0;">
                <form class="form-horizontal" action="{{ route('ahpc.store') }}" id="multistep_form" method="POST"
                                        ...
                                        <select class="form-select">
                                            @if (!empty($FeeStructures))
                                                @foreach ($FeeStructures as $FeeStructure)
                                                    <option value="{{ $FeeStructure->fee }}">{{ $FeeStructure->cdd }}
                                                    </option>
                                                @endforeach
                                            @endif
                                        </select>
