...
@section('content')
    ...
    <div id="carouselExampleIndicators" class="carousel slide">
        ...
        <div class="carousel-inner" style="height: max-content;">
            <div class="carousel-item active c-item">
                <img src="{{ asset('build/images/siteimages/slider-img-1.jpg') }}" class="d-block w-100 c-img  h-100" alt="...">
            </div>
            <div class="carousel-item c-item">
                <img src="{{ asset('build/images/siteimages/slider-image-2.jpeg') }}" class="d-block w-100 c-img  h-100" alt="...">
            </div>
            <div class="carousel-item c-item">
                <img src="{{ asset('build/images/siteimages/slider-img-3.jpg') }}" class="d-block w-100 c-img  h-100" alt="...">
            </div>
    ...
    <div class="container border border-success px-2 py-4"
        ...
        <div class="box d-flex justify-content-around align-items-center search-ahpc">
            ...
            <a href="{{ url('/site/profile') }}" type="button" class="mb-3 col-lg-2 col-md-2 fs-5 btn btn-outline-success rounded-0 btn-lg px-md-2 py-2 px-lg-5">Search</a>
        </div>
            ...
            <div class="row all-blogs justify-content-center" id="blogsect">
                ...
                <div class="col-md-3">
                    <div class="col-md-12 sectionblog">
                        <div class="image_wrapper">
                            <img src="{{ asset('build/images/blog1.jpg') }}" alt="" />
                    ...
                    <div class="col-md-12 sectionblog">
                        <div class="image_wrapper">
                            <img src="{{ asset('build/images/blog2.jpeg') }}" alt=""  style="border-radius: 0" />
                    ...
                    <div class="col-md-12 sectionblog">
                        <div class="image_wrapper">
                            <img src="{{ asset('build/images/blog3.jpg') }}" alt=""  style="border-radius: 0 0 0 20px" />
                ...
                <div class="col-md-5 sectionblog">
                    <div class="image_wrapper main-blog">
                        <img src="{{ asset('build/images/blog7.avif') }}" alt=""  style="border-radius: 0; height: 600px" />
                        <div class="overlay overlay_2" style="border-radius: 0 ">
                ...
                <div class="col-md-3 ">
                    <div class="col-md-12 sectionblog">
                        <div class="image_wrapper">
                            <img src="{{ asset('build/images/blog4.jpg') }}" alt=""  style="border-radius: 0 20px 0 0" />
                    ...
                    <div class="col-md-12 sectionblog">
                        <div class="image_wrapper">
                            <img src="{{ asset('build/images/blog5.webp') }}" alt=""  style="border-radius: 0" />
                            <div class="overlay overlay_2" style="border-radius: 0">
                    ...
                    <div class="col-md-12 sectionblog">
                        <div class="image_wrapper">
                            <img src="{{ asset('build/images/blog6.jpg') }}" alt=""  style="border-radius: 0 0 20px 0;" />
    ...
    <div class="container mt-3" id="con" style="box-shadow: 0px 6px 12px #9de9a7;">
        <div class="row my-5">
            <div class="col-md-8  px-0 py-">
                <img src="{{asset('build/images/slider-img-1.png')}}" class="w-100" id="img" alt="">
            </div>
            <div class="col-md-4">
                ...
                <div class="card dis-card ">
                    <div class="card-body">
                        ...
                        <a href="{{ url('/our/descipline') }}" class="btn btn-outline-success btn-read text-center mx-3">Read more</a>
                    </div>
                </div>
