...
<div class="container">
    ...
    margin: 20px 0;">
            <form class="form-horizontal" action="{{ route('overseass.store') }}" id="multistep_form" method="POST" enctype="multipart/form-data">
                @csrf
                <fieldset id="account">
                        ...
                        <div class="form-group">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <select class="form-select">
                                        @if (!empty($FeeStructures))
                                            ...
                                            <option value="{{ $FeeStructure->fee }}">{{ $FeeStructure->cdd }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                            ...
                            {{-- <div class="row col-md-12 justify-content-center">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="date" class="form-control" value="" name="fee_deposit_date">
                                </div>
                            </div> --}}
                            <div class="row col-md-12 justify-content-center">
                                <div class="mb-3 col-md-6">
