                                                    ...
                                                    <div class="d-flex flex-column h-100">
                                                        <div class="mb-4 mb-md-5">
                                                            <a href="index" class="d-block auth-logo">
                                                                <img src="{{ URL::asset('build/images/ahpc logo png.png')}}" alt="" height="22" class="auth-logo-dark me-start">
                                                                <img src="{{ URL::asset('build/images/ahpc logo png.png')}}" alt="" height="22" class="auth-logo-light me-start">
                                                            </a>
                                                        </div>
                                                        ...
                                                        <div class="mt-4 text-center">
                                                            <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> Borex   . Crafted with <i class="mdi mdi-heart text-danger"></i> by STH</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
