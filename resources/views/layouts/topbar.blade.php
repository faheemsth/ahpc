            ...
            <div class="d-flex align-items-center">
                ...
                <div class="ms-1 header-item d-none d-sm-flex">
                    <a type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" href="/">
                        ...
                        {{-- <i class='bx bxs-low-vision fs-22' ></i> --}}
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            ...
                            <img class="rounded-circle header-profile-user" src="@if (Auth::user()->avatar != '') {{ URL::asset(Auth::user()->avatar) }}@else{{ URL::asset('build/images/users/inst.png') }} @endif" alt="Header Avatar">
                            @else
                            <img class="rounded-circle header-profile-user" src="@if (Auth::user()->avatar != '') {{ URL::asset(Auth::user()->avatar) }}@else{{ URL::asset('build/images/users/user-dummy-img.jpg') }} @endif" alt="Header Avatar">
                            @endif
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{\Auth::user()->first_name }}</span>
                            @if(Auth::user()->role_id == 2)
                                <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text">{{\Auth::user()->institute_type}}</span>
                            @endif
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        {{-- <h6 class="dropdown-header">Welcome Zamarud khan !</h6> --}}
                        @if(\Auth::user()->role_id == 2)
